...
const Summarizer: React.FC<SummarizerProps> = ({ onSave, notes, onAddToNote }) => {
    ...
    const saveCustomMode = async () => {
        ...
        try {
            ...
            notify.error('Failed to save custom mode. Please try again.');
        }
    };
    ...
    const deleteCustomMode = async (modeId: string) => {
        try {
            ...
            notify.error('Failed to delete custom mode. Please try again.');
        }
    };
    ...
    const startRecording = async () => {
        try {
            ...
            notify.info("Could not access microphone.");
        }
    };
    ...
    const handleDeleteSummary = async (summaryId: string) => {
        try {
            ...
            notify.error('Failed to delete summary. Please try again.');
        }
    };
